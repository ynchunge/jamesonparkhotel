			...
			<div class="row" style="flex-wrap: nowrap;">
				<div class="col-md-6 home-left-section">
					<div style="padding: 100px 0px; color: white;">
						...
						<hr>
						<p>
						Nairobi's Leading Steak Restaurant  
						</p>
				...
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>
	                    	We pick the best meat from local based farmers which ensures the best tender and quality meat
							</p>
	                    </div>
	                </div>
				</div>
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>
	                        	We offer fast delivey services to your doorstep across Nairobi at affordable rates
	                        </p>
	                    </div>
	                </div>
				</div>
					...
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        <h3>
	                            Quality Service	                        </h3>
	                        <p>
	                        	We pick the best trained staff members who ensure the meals are toptier and ensure customers get the best quality care.
	                        </p>
	                    </div>
	                </div>
				</div>
            ...
            <div class="row">
                <div class="col-lg-6 sm-padding">
                    <div class="contact-info">
                        ...
                        <h4>
                            <span>Email:</span> 
                            <p>jamesonparkhotel@gmail.com </p>
                            <span>Phone:</span> 
                            <p> +254 713529686 </p>
                        </h4>
                    </div>
                ...
                <div class="col-lg-5 col-md-7">
                    <div class="footer_widget">
                        ...
                        <ul class="opening_time">
                            <li>Monday - Saturday 11:30am - 9:00pm</li>
                            <li>Sunday & Public Holidays 11:30am - 8:00pm</li>
